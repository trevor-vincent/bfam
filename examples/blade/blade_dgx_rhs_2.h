...
#define X(order)                                                     \
  ...
  void blade_dgx_inter_rhs_interface_2_##order(int N,                \
      bfam_subdomain_dgx_t *sub, const char *rate_prefix,            \
      const char *field_prefix, const bfam_long_real_t t);           \
  void blade_dgx_add_rates_advection_2_##order(int N,                \
      ...
      const bfam_long_real_t a);                                     \
  void blade_dgx_add_rates_glue_p_2_##order(int N,                   \
      bfam_subdomain_dgx_t *sub, const char *field_prefix_lhs,       \
      const char *field_prefix_rhs, const char *rate_prefix,         \
      const bfam_long_real_t a,                                      \
...
void blade_dgx_intra_rhs_advection_2_(int N,
    bfam_subdomain_dgx_t *sub, const char *rate_prefix,
    const char *field_prefix, const bfam_long_real_t t);
void blade_dgx_inter_rhs_interface_2_(int N,
    bfam_subdomain_dgx_t *sub, const char *rate_prefix,
    const char *field_prefix, const bfam_long_real_t t);
void blade_dgx_add_rates_advection_2_(int N,
    ...
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a);
void blade_dgx_add_rates_glue_p_2_(int N,
    bfam_subdomain_dgx_t *sub, const char *field_prefix_lhs,
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a,
    const char** scals, const char** vects, const char** tens);
